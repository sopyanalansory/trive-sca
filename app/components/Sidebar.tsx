...
interface SidebarProps {
  ...
  setProfileHovered: (hovered: boolean) => void;
  userName: string;
  userInitial: string;
  activePage?: "accounts" | "platform";
}
        ...
        <nav className="flex-1 p-4">
          <ul className="space-y-1">
            <li>
              <Link
                href="/accounts"
                className={`flex items-center ${sidebarOpen ? "justify-between" : "justify-center"} p-3 rounded-lg ${
                  activePage === "accounts" 
            ...
            <li>
              <Link
                href="/platform"
                className={`flex items-center ${sidebarOpen ? "justify-start" : "justify-center"} p-3 rounded-lg ${
                  activePage === "platform" 
                    ? "bg-[#334155] text-white" 
                    : "text-gray-300 hover:bg-[#334155] hover:text-white"
                } transition-colors`}
