...
export default function AdditionalStatement6Page() {
  ...
  const handleNext = () => {
    ...
    router.push("/open-investment-account/additional-statement-7");
  };
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4 w-full min-w-0 max-w-full">
                ...
                <div className="mb-6">
                  ...
                  <div className="text-xs text-gray-700 mb-6 leading-relaxed">
                    Dengan mengisi kolom "YA" dibawah ini, saya menyatakan bertanggung jawab penuh atas kode akses transaksi Nasabah (Personal Access Password) dan tidak menyerahkan kode akses transaksi Nasabah (Personal Access Password) kepada pihak lain khususnya kepada Pialang Berjangka, pegawai atau pihak yang berkepentingan dengan Pialang Berjangka.
                  </div>

                  {/* Warning Box */}
                  <div className="border-2 border-gray-900 p-4 mb-6 text-center">
                    <div className="font-semibold text-xs text-gray-900 mb-2">PERINGATAN!</div>
                    <div className="text-xs text-gray-900 leading-relaxed">
                      Pialang Berjangka, Wakil Pialang Berjangka, Pegawai Pialang Berjangka, atau pihak lain yang mempunyai kepentingan dengan Pialang Berjangka dilarang menerima Password Akses Pribadi Nasabah
                    </div>
                  </div>

                  <div className="text-xs text-gray-700 mb-6 leading-relaxed">
                    Demikian pernyataan ini dibuat dalam keadaan sadar, sehat jasmani dan rohani serta tanpa adanya paksaan dari pihak manapun.
                  </div>
                </div>
